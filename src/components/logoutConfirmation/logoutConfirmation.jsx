    ...
    <div className='logoutMainDiv'>
        <div className="logoutDiv">
            ...
            <div className="buttonViewGroup">
                <CommonButton textColor={'#fff'} buttonColor={'#17A2B8'} text={'Yes, Logout'} box-shadow={' 0px 2px 12px 0px #82698C33'} border={'none'} onClick={()=>{localStorage.removeItem('token'); setIsLoggedIn(false); setIsLoggingOut(true)}}/>
